...
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>密码确认：</label>
        <input type="text" name="re_passwd" placeholder="密码确认" />
    </p>
    <p class="short-input ue-clear">
    	<label>昵称：</label>
    ...
    <div class="short-input select ue-clear">
    	<label>所属部门：</label>
        <select name="deptid">
	        <?php if(is_array($dlist)): foreach($dlist as $key=>$v): ?><option value="<?php echo ($v["dept_id"]); ?>"><?php echo ($v["dept_name"]); ?></option><?php endforeach; endif; ?>
        </select>   
    </div>
    <p class="short-input ue-clear">
    	<label>性别：</label>
