...
<input type="hidden" name="id" value="<?php echo ($dshow["dept_id"]); ?>" />
<div class="main">
    <p class="short-input ue-clear">
    	<label>部门：</label>
        <input type="text" placeholder="部门名称" name="name" value="<?php echo ($dshow["dept_name"]); ?>"/>
    </p>
    <div class="short-input select ue-clear">
        ...
        <div class="select-wrap">
        	<select name="pid">
                ...
                <?php if(is_array($dlist)): foreach($dlist as $key=>$vo): if($dshow["dept_pid"] == $vo["dept_id"] ): ?><option value="<?php echo ($vo['dept_id']); ?>" selected="selected"><?php echo ($vo["dept_name"]); ?></option>
                        <?php else: ?>
    ...
    <p class="short-input ue-clear">
    	<label>排序：</label>
        <input type="text" name="sort" value="<?php echo ($dshow["dept_sort"]); ?>"/>
    </p>
    <p class="short-input ue-clear">
    	<label>备注信息：</label>
        <textarea placeholder="请输入内容" name="remark" ><?php echo ($dshow["dept_remark"]); ?></textarea>
    </p>
</div>
