...
<link rel="stylesheet" type="text/css" href="/oa/Public/Admin/css/jquery.dialog.css" />
<link rel="stylesheet" href="/oa/Public/Admin/css/index.css" />
  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:;" class="user-name"><?php echo (session('nickName')); ?></a></div>
  ...
  <div id="bd">
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          <?php if(is_array($level0)): foreach($level0 as $key=>$v): ?><li class="<?php echo ($v["node_title"]); ?>"> 
            <div class="nav-header"><a href="javascript:;" class="ue-clear">
            <span><?php echo ($v["node_name"]); ?></span><i class="icon"></i></a></div>
            <ul class="subnav">
              <?php if(is_array($level1)): foreach($level1 as $key=>$vo): if($vo["node_pid"] == $v["node_id"] ): ?><li><a href="javascript:;" date-src="<?php echo U($vo['node_controller'].'/'.$vo['node_action']);?>"><?php echo ($vo["node_name"]); ?></a></li><?php endif; endforeach; endif; ?>
            </ul>
...
<script type="text/javascript" src="/oa/Public/Admin/js/jquery.dialog.js"></script>
<script type="text/javascript" src="/oa/Public/Admin/js/index.js"></script>
</html>